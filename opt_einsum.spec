...
%prep
%setup -q -n opt_einsum-3.1.0
cd %{_builddir}/opt_einsum-3.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583538038
...
cp %{_builddir}/opt_einsum-3.1.0/LICENSE %{buildroot}/usr/share/package-licenses/opt_einsum/a2545d1b3d4d2470b78d1563425520cb7bf34dea
