...
Source0  : https://files.pythonhosted.org/packages/7d/ba/b7b87195f0e9f7d452d1fb9eed4e43ecf077c1b08d2a87b56f721d7aa1dc/opt_einsum-3.2.0.tar.gz
...
%prep
%setup -q -n opt_einsum-3.2.0
cd %{_builddir}/opt_einsum-3.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1584381600
...
cp %{_builddir}/opt_einsum-3.2.0/LICENSE %{buildroot}/usr/share/package-licenses/opt_einsum/a2545d1b3d4d2470b78d1563425520cb7bf34dea
